...
const About = () => {
  ...
  const skills = ['C/C++', 'Linux', 'Python', 'Git', 'Rust', 'Vim/Neovim'];
    ...
    <StyledAboutSection id="about" ref={revealContainer}>
      ...
      <div className="inner">
        <StyledText>
          <div>
            <p>
              Hello! My name is Shen Fu and I enjoy giving clean and elegant solutions to real-world
              problems in the form of code. My interest in modern technology makes me choose to
              study computer science and keep me moving forward on this road.
            </p>
